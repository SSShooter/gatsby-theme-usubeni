...
odate: '2021-03-23T09:53:29.360Z'
date: '2022-02-24T09:53:29.360Z'
title: 'Vue 优化速查'
tags: ['coding', 'Vue']
---
...
经过[官方文档](https://v2.vuejs.org/v2/guide/computed.html)的强调，可以说是众所周知，computed 可以缓存计算结果，在依赖的值不变时减少计算消耗时间。

同样众所周知的还有 **KeepAlive** 组件。
...
我不愿意做一个全世界都适用的轮子。因为每个人的需求都是不同的，如果要做一个满足所有人的要求的轮子，这个轮子就会变得很重，我个人不太愿意看到……

所以我希望做的“轮子”是一个轻量化的，满足最小功能要求的“框架”，这样大家修改也方便，同时也不必担心随着不断更新越来越重。例如 [v-vld](https://github.com/v-cpn/v-vld) 和 [tbl]。(https://github.com/v-cpn/cpn-tbl)
...
**这种做法在数据嵌套很深时有起效**，阻断 `defineReactive` 后不会递归处理数据里的子对象。（**数据扁平化**也可以免除递归）
...
相关传送门：[requestAnimationFrame](https://ssshooter.com/2021-03-23-optimization-checklist/#javascript)
